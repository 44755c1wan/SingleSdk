...
//    public static String phoentell;//弹窗交互获得到的手机号
    ...
    public static String oderstatus = "";
...
//	public static String logininfo ="http://www.44755.com/user-api_cplogintest";//测试地址
    ...
    public static String versioncode = "";//游戏内版本号
	...
	public static String phonetell;
	
	public static String nettype="";//联网方式
